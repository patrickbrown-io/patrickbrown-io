...
const aboutMe = {
   pronouns: "he" || "him",
   code: [TypeScript, JavaScript, PHP, Python, C++, HTML, CSS],
   technologies: {
      frontEnd: {
         js: [React, "jQuery", "Web Components"],
         css: ["Bootstrap", "Tailwind CSS", "Bulma", "Styled-Components", "Semantic UI", "Material UI"],
   ...
   currentChallenges: ["PERN Multiplayer Web Application", "Bachelor of Science: Computer Science - Colorado University, Boulder"]
};
```
